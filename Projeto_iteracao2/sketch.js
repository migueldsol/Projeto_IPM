...
let draw_filter           = false;  // used to control drawing the filter
...
{
  //creates buttons
  let fruits = new ButtonCat(100,100,100, "fruits", 100);
  let vegetables = new ButtonCat(200,100,100,"vegetables", 100);
  let juices = new ButtonCat(300,100,100, "juices", 100);
  let milks = new ButtonCat(400,100,100, "milks", 100);
  let weirds = new ButtonCat(500,100,100, "weirds", 100);
...
function draw()
{
  ...
  {     
    ...
    // Draw all targets
	for (var i = 0; i < targets.size(); i++) targets[i].draw();
  ...
  else if (draw_filter)
  {
    ...
    // Draw all targets
	for (var i = 0; i < 6; i++) buttons[i].draw();
